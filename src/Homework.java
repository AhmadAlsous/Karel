...
public class Homework extends SuperKarel {
  ...
  private void fillInnerChambers(){
    ...
    turnRight();
    moveAndPutBeeper((this.squareLength-1)/2); // fill second half first side
  }
  
  private void fillHorizontalOuterChambers(){
    moveToCenterRow();
    turnRight();
    moveAndPutBeeper((this.width-1)/2); // fill half the width
  ...
  private void moveToSquareStart(){
    ...
    // the wall, more if width is greater than height
